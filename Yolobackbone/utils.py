...
from Yolobackbone.model import Yolo
...
def train(train_loader, validation_loader, optimizer, epoch, lr=1e-3):
    ...
    pbar = tqdm(range(epoch), desc="Training Yolo Backbone")
    ...
    plot(title="Yolo Backbone Train", sub_titles=["Loss", "IOU"], \
...
if __name__ == "__main__":
    ...
    cv2.imwrite("Yolobackbone/example.jpg", image)
    cv2.waitKey(0)